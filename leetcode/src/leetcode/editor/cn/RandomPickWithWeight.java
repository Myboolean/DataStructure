...
// 
//
// Related Topics 数学 二分查找 前缀和 随机化 👍 274 👎 0
...
public class RandomPickWithWeight{
     public static void main(String[] args) {
         //测试代码
         Solution solution = new RandomPickWithWeight().new Solution(new int[]{});
     }
//力扣代码
...
class Solution {
    ...
    public int pickIndex() {
        int n = s.length ;
        int target = random.nextInt(s[n - 1]) + 1;
        return right_bound(target) - 1;

    }
    public int right_bound(int f) {

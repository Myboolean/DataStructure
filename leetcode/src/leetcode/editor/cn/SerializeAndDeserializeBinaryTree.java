...
// 
//
// Related Topics 树 深度优先搜索 广度优先搜索 设计 字符串 二叉树 👍 1013 👎 0
...
public class Codec {
    ...
    public TreeNode dfsdeserialize(Queue<String> r){
        if("null".equals(r.peek())){
            r.poll();
            return null;
        }
        assert r.peek() != null;
        TreeNode node=new TreeNode(Integer.parseInt(r.peek()));
        r.poll();
